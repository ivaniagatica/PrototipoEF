...
namespace CapaVista
{
    public partial class mantenimientoBodega : Form
    {
        ...
        public mantenimientoBodega()
        {
            ...
            navegador1.idAplicacion = "1000";//en la nueva se usara el nombre
            ...
            navegador1.funLlenarComboControl(cmbEmpresa, "tipobodega", "pkid", "nombre", "estado");
        ...
        public void funActualizarUsuario(string user)
        {
            ...
            navegador1.aplicacion = "Bodega";//nombre de la app en seguridad
